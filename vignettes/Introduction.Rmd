...
```{r}
bench::mark(
  html_decode(strings, backend = "rcpp"),
  unescape_html2(strings),
  textutils::HTMLdecode(strings)
)
```

Clearly, the speed of `html_decode` function is unparalled.
...
but the CRAN version may not. This means that if you test the performance youself with a previous version
